                  ...
                  <div className="d-flex align-items-center gap-3">
                    ...
                    {!isAuthenticated ? (
                      ...
                      <div className="position-relative" ref={dropdownRef}>
                        {/* แสดงยอดเงิน - ใช้ข้อมูลจาก member_balance */}
                        <label style={{ marginRight: 10 }}>
                          {user?.member_balance?.balance !== undefined
                            ? `${user.member_balance.balance.toFixed(2)} ฿`
                            : "0.00 ฿"}
                        </label>
                        <button
                          className="ud-btn btn-thm add-joining"
                        ...
                        >
                          ...
                          <i className="fas fa-chevron-down ml-1 fs-12"></i>
                        </button>
